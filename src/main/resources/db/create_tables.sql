...
CREATE TABLE car (
  ...
  car_status         ENUM ('available', 'reserved', 'served', 'returned', 'unavailable', 'maintained') NOT NULL DEFAULT 'unavailable',
...
CREATE TABLE reservation (
  ...
  reservation_status ENUM ('new', 'approved', 'rejected', 'picked', 'dropped') NOT NULL DEFAULT 'new',
